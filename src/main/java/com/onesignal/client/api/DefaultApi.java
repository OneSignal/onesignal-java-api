...
import com.onesignal.client.model.ApiKeyTokensListResponse;
...
import com.onesignal.client.model.StartLiveActivityRequest;
import com.onesignal.client.model.StartLiveActivitySuccessResponse;
import com.onesignal.client.model.SubscriptionBody;
import com.onesignal.client.model.TemplateResource;
...
public class DefaultApi {
    ...
    public okhttp3.Call cancelNotificationCall(String appId, String notificationId, final ApiCallback _callback) throws ApiException {
        ...
        localVarHeaderParams.put("OS-Usage-Data", "kind=sdk, sdk-name=onesignal-java, version=5.11.0");
    ...
    /**
     * Build call for copyTemplateToApp
    ...
    public okhttp3.Call copyTemplateToAppCall(String templateId, String appId, CopyTemplateRequest copyTemplateRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/templates/{template_id}/copy_to_app"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call copyTemplateToAppValidateBeforeCall(String templateId, String appId, CopyTemplateRequest copyTemplateRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'templateId' is set
        if (templateId == null) {
            throw new ApiException("Missing the required parameter 'templateId' when calling copyTemplateToApp(Async)");
        }
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling copyTemplateToApp(Async)");
        }
        
        // verify the required parameter 'copyTemplateRequest' is set
        if (copyTemplateRequest == null) {
            throw new ApiException("Missing the required parameter 'copyTemplateRequest' when calling copyTemplateToApp(Async)");
        }
        

        okhttp3.Call localVarCall = copyTemplateToAppCall(templateId, appId, copyTemplateRequest, _callback);
        return localVarCall;
    ...
    public TemplateResource copyTemplateToApp(String templateId, String appId, CopyTemplateRequest copyTemplateRequest) throws ApiException {
        ApiResponse<TemplateResource> localVarResp = copyTemplateToAppWithHttpInfo(templateId, appId, copyTemplateRequest);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<TemplateResource> copyTemplateToAppWithHttpInfo(String templateId, String appId, CopyTemplateRequest copyTemplateRequest) throws ApiException {
        okhttp3.Call localVarCall = copyTemplateToAppValidateBeforeCall(templateId, appId, copyTemplateRequest, null);
        Type localVarReturnType = new TypeToken<TemplateResource>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Copy template to another app (asynchronously)
     * Copy a template to a destination app.
     * @param templateId  (required)
     * @param appId  (required)
     * @param copyTemplateRequest  (required)
    ...
    public okhttp3.Call copyTemplateToAppAsync(String templateId, String appId, CopyTemplateRequest copyTemplateRequest, final ApiCallback<TemplateResource> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = copyTemplateToAppValidateBeforeCall(templateId, appId, copyTemplateRequest, _callback);
        Type localVarReturnType = new TypeToken<TemplateResource>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public okhttp3.Call createApiKeyCall(String appId, CreateApiKeyRequest createApiKeyRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/apps/{app_id}/auth/tokens"
            .replaceAll("\\{" + "app_id" + "\\}", localVarApiClient.escapeString(appId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createApiKeyValidateBeforeCall(String appId, CreateApiKeyRequest createApiKeyRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling createApiKey(Async)");
        }
        ...
        okhttp3.Call localVarCall = createApiKeyCall(appId, createApiKeyRequest, _callback);
        return localVarCall;
    ...
    public CreateApiKeyResponse createApiKey(String appId, CreateApiKeyRequest createApiKeyRequest) throws ApiException {
        ApiResponse<CreateApiKeyResponse> localVarResp = createApiKeyWithHttpInfo(appId, createApiKeyRequest);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<CreateApiKeyResponse> createApiKeyWithHttpInfo(String appId, CreateApiKeyRequest createApiKeyRequest) throws ApiException {
        okhttp3.Call localVarCall = createApiKeyValidateBeforeCall(appId, createApiKeyRequest, null);
    ...
    public okhttp3.Call createApiKeyAsync(String appId, CreateApiKeyRequest createApiKeyRequest, final ApiCallback<CreateApiKeyResponse> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createApiKeyValidateBeforeCall(appId, createApiKeyRequest, _callback);
        Type localVarReturnType = new TypeToken<CreateApiKeyResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for createCustomEvents
     * @param appId Your OneSignal App ID in UUID v4 format. (required)
     * @param customEventsRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call createCustomEventsCall(String appId, CustomEventsRequest customEventsRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/apps/{app_id}/integrations/custom_events"
            .replaceAll("\\{" + "app_id" + "\\}", localVarApiClient.escapeString(appId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createCustomEventsValidateBeforeCall(String appId, CustomEventsRequest customEventsRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling createCustomEvents(Async)");
        }
        
        // verify the required parameter 'customEventsRequest' is set
        if (customEventsRequest == null) {
            throw new ApiException("Missing the required parameter 'customEventsRequest' when calling createCustomEvents(Async)");
        }
        

        okhttp3.Call localVarCall = createCustomEventsCall(appId, customEventsRequest, _callback);
        return localVarCall;
    ...
    public Object createCustomEvents(String appId, CustomEventsRequest customEventsRequest) throws ApiException {
        ApiResponse<Object> localVarResp = createCustomEventsWithHttpInfo(appId, customEventsRequest);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Object> createCustomEventsWithHttpInfo(String appId, CustomEventsRequest customEventsRequest) throws ApiException {
        okhttp3.Call localVarCall = createCustomEventsValidateBeforeCall(appId, customEventsRequest, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create custom events (asynchronously)
     * The Custom Events API allows you to record user events. Custom events can represent any action users take in your application, such as completing a purchase, viewing content, or achieving milestones.
     * @param appId Your OneSignal App ID in UUID v4 format. (required)
     * @param customEventsRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    public okhttp3.Call createCustomEventsAsync(String appId, CustomEventsRequest customEventsRequest, final ApiCallback<Object> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createCustomEventsValidateBeforeCall(appId, customEventsRequest, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call createTemplateValidateBeforeCall(CreateTemplateRequest createTemplateRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createTemplateCall(createTemplateRequest, _callback);
        return localVarCall;
    ...
    public TemplateResource createTemplate(CreateTemplateRequest createTemplateRequest) throws ApiException {
        ApiResponse<TemplateResource> localVarResp = createTemplateWithHttpInfo(createTemplateRequest);
        return localVarResp.getData();
    }
    ...
    public okhttp3.Call deleteApiKeyCall(String appId, String tokenId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/apps/{app_id}/auth/tokens/{token_id}"
            .replaceAll("\\{" + "app_id" + "\\}", localVarApiClient.escapeString(appId.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteApiKeyValidateBeforeCall(String appId, String tokenId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling deleteApiKey(Async)");
        }
        
        // verify the required parameter 'tokenId' is set
        if (tokenId == null) {
            throw new ApiException("Missing the required parameter 'tokenId' when calling deleteApiKey(Async)");
        }
        

        okhttp3.Call localVarCall = deleteApiKeyCall(appId, tokenId, _callback);
        return localVarCall;
    ...
    public Object deleteApiKey(String appId, String tokenId) throws ApiException {
        ApiResponse<Object> localVarResp = deleteApiKeyWithHttpInfo(appId, tokenId);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Object> deleteApiKeyWithHttpInfo(String appId, String tokenId) throws ApiException {
        okhttp3.Call localVarCall = deleteApiKeyValidateBeforeCall(appId, tokenId, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call deleteApiKeyAsync(String appId, String tokenId, final ApiCallback<Object> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteApiKeyValidateBeforeCall(appId, tokenId, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteTemplateValidateBeforeCall(String templateId, String appId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteTemplateCall(templateId, appId, _callback);
        return localVarCall;
    ...
    public GenericSuccessBoolResponse deleteTemplate(String templateId, String appId) throws ApiException {
        ApiResponse<GenericSuccessBoolResponse> localVarResp = deleteTemplateWithHttpInfo(templateId, appId);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<GenericSuccessBoolResponse> deleteTemplateWithHttpInfo(String templateId, String appId) throws ApiException {
        okhttp3.Call localVarCall = deleteTemplateValidateBeforeCall(templateId, appId, null);
        Type localVarReturnType = new TypeToken<GenericSuccessBoolResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call deleteTemplateAsync(String templateId, String appId, final ApiCallback<GenericSuccessBoolResponse> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteTemplateValidateBeforeCall(templateId, appId, _callback);
        Type localVarReturnType = new TypeToken<GenericSuccessBoolResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public okhttp3.Call rotateApiKeyCall(String appId, String tokenId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/apps/{app_id}/auth/tokens/{token_id}/rotate"
            .replaceAll("\\{" + "app_id" + "\\}", localVarApiClient.escapeString(appId.toString()))
            .replaceAll("\\{" + "token_id" + "\\}", localVarApiClient.escapeString(tokenId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call rotateApiKeyValidateBeforeCall(String appId, String tokenId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling rotateApiKey(Async)");
        }
        
        // verify the required parameter 'tokenId' is set
        if (tokenId == null) {
            throw new ApiException("Missing the required parameter 'tokenId' when calling rotateApiKey(Async)");
        }
        

        okhttp3.Call localVarCall = rotateApiKeyCall(appId, tokenId, _callback);
        return localVarCall;
    ...
    public CreateApiKeyResponse rotateApiKey(String appId, String tokenId) throws ApiException {
        ApiResponse<CreateApiKeyResponse> localVarResp = rotateApiKeyWithHttpInfo(appId, tokenId);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<CreateApiKeyResponse> rotateApiKeyWithHttpInfo(String appId, String tokenId) throws ApiException {
        okhttp3.Call localVarCall = rotateApiKeyValidateBeforeCall(appId, tokenId, null);
        Type localVarReturnType = new TypeToken<CreateApiKeyResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call rotateApiKeyAsync(String appId, String tokenId, final ApiCallback<CreateApiKeyResponse> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = rotateApiKeyValidateBeforeCall(appId, tokenId, _callback);
        Type localVarReturnType = new TypeToken<CreateApiKeyResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for startLiveActivity
     * @param appId Your OneSignal App ID in UUID v4 format. (required)
     * @param activityType The name of the Live Activity defined in your app. This should match the attributes struct used in your app&#39;s Live Activity implementation. (required)
     * @param startLiveActivityRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call startLiveActivityCall(String appId, String activityType, StartLiveActivityRequest startLiveActivityRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = startLiveActivityRequest;

        // create path and map variables
        String localVarPath = "/apps/{app_id}/activities/activity/{activity_type}"
            .replaceAll("\\{" + "app_id" + "\\}", localVarApiClient.escapeString(appId.toString()))
            .replaceAll("\\{" + "activity_type" + "\\}", localVarApiClient.escapeString(activityType.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call startLiveActivityValidateBeforeCall(String appId, String activityType, StartLiveActivityRequest startLiveActivityRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling startLiveActivity(Async)");
        }
        
        // verify the required parameter 'activityType' is set
        if (activityType == null) {
            throw new ApiException("Missing the required parameter 'activityType' when calling startLiveActivity(Async)");
        }
        
        // verify the required parameter 'startLiveActivityRequest' is set
        if (startLiveActivityRequest == null) {
            throw new ApiException("Missing the required parameter 'startLiveActivityRequest' when calling startLiveActivity(Async)");
        }
        

        okhttp3.Call localVarCall = startLiveActivityCall(appId, activityType, startLiveActivityRequest, _callback);
        return localVarCall;
    ...
    public StartLiveActivitySuccessResponse startLiveActivity(String appId, String activityType, StartLiveActivityRequest startLiveActivityRequest) throws ApiException {
        ApiResponse<StartLiveActivitySuccessResponse> localVarResp = startLiveActivityWithHttpInfo(appId, activityType, startLiveActivityRequest);
        return localVarResp.getData();
    }
     ...
     * @param activityType The name of the Live Activity defined in your app. This should match the attributes struct used in your app&#39;s Live Activity implementation. (required)
     * @param startLiveActivityRequest  (required)
     * @return ApiResponse&lt;StartLiveActivitySuccessResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
    ...
    public ApiResponse<StartLiveActivitySuccessResponse> startLiveActivityWithHttpInfo(String appId, String activityType, StartLiveActivityRequest startLiveActivityRequest) throws ApiException {
        okhttp3.Call localVarCall = startLiveActivityValidateBeforeCall(appId, activityType, startLiveActivityRequest, null);
        Type localVarReturnType = new TypeToken<StartLiveActivitySuccessResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call startLiveActivityAsync(String appId, String activityType, StartLiveActivityRequest startLiveActivityRequest, final ApiCallback<StartLiveActivitySuccessResponse> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = startLiveActivityValidateBeforeCall(appId, activityType, startLiveActivityRequest, _callback);
        Type localVarReturnType = new TypeToken<StartLiveActivitySuccessResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateApiKeyValidateBeforeCall(String appId, String tokenId, UpdateApiKeyRequest updateApiKeyRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling updateApiKey(Async)");
        }
        
        // verify the required parameter 'tokenId' is set
        if (tokenId == null) {
            throw new ApiException("Missing the required parameter 'tokenId' when calling updateApiKey(Async)");
        }
        ...
        okhttp3.Call localVarCall = updateApiKeyCall(appId, tokenId, updateApiKeyRequest, _callback);
        return localVarCall;
    ...
    public Object updateApiKey(String appId, String tokenId, UpdateApiKeyRequest updateApiKeyRequest) throws ApiException {
        ApiResponse<Object> localVarResp = updateApiKeyWithHttpInfo(appId, tokenId, updateApiKeyRequest);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Object> updateApiKeyWithHttpInfo(String appId, String tokenId, UpdateApiKeyRequest updateApiKeyRequest) throws ApiException {
        okhttp3.Call localVarCall = updateApiKeyValidateBeforeCall(appId, tokenId, updateApiKeyRequest, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call updateApiKeyAsync(String appId, String tokenId, UpdateApiKeyRequest updateApiKeyRequest, final ApiCallback<Object> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateApiKeyValidateBeforeCall(appId, tokenId, updateApiKeyRequest, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public Object updateSubscriptionByToken(String appId, String tokenType, String token, SubscriptionBody subscriptionBody) throws ApiException {
        ApiResponse<Object> localVarResp = updateSubscriptionByTokenWithHttpInfo(appId, tokenType, token, subscriptionBody);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Object> updateSubscriptionByTokenWithHttpInfo(String appId, String tokenType, String token, SubscriptionBody subscriptionBody) throws ApiException {
        okhttp3.Call localVarCall = updateSubscriptionByTokenValidateBeforeCall(appId, tokenType, token, subscriptionBody, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update subscription by token (asynchronously)
     * Update properties on an existing OneSignal subscription using its token.
     * @param appId Your OneSignal App ID in UUID v4 format. (required)
     * @param tokenType The type of token to use when looking up the subscription. See Subscription Types. (required)
     * @param token The value of the token to lookup by (e.g., email address, phone number). (required)
    ...
    public okhttp3.Call updateSubscriptionByTokenAsync(String appId, String tokenType, String token, SubscriptionBody subscriptionBody, final ApiCallback<Object> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateSubscriptionByTokenValidateBeforeCall(appId, tokenType, token, subscriptionBody, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateTemplateValidateBeforeCall(String templateId, String appId, UpdateTemplateRequest updateTemplateRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateTemplateCall(templateId, appId, updateTemplateRequest, _callback);
        return localVarCall;
    ...
    public TemplateResource updateTemplate(String templateId, String appId, UpdateTemplateRequest updateTemplateRequest) throws ApiException {
        ApiResponse<TemplateResource> localVarResp = updateTemplateWithHttpInfo(templateId, appId, updateTemplateRequest);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<TemplateResource> updateTemplateWithHttpInfo(String templateId, String appId, UpdateTemplateRequest updateTemplateRequest) throws ApiException {
        okhttp3.Call localVarCall = updateTemplateValidateBeforeCall(templateId, appId, updateTemplateRequest, null);
        Type localVarReturnType = new TypeToken<TemplateResource>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call updateTemplateAsync(String templateId, String appId, UpdateTemplateRequest updateTemplateRequest, final ApiCallback<TemplateResource> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateTemplateValidateBeforeCall(templateId, appId, updateTemplateRequest, _callback);
        Type localVarReturnType = new TypeToken<TemplateResource>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call viewApiKeysValidateBeforeCall(String appId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling viewApiKeys(Async)");
        }
        

        okhttp3.Call localVarCall = viewApiKeysCall(appId, _callback);
        return localVarCall;
    ...
    public ApiKeyTokensListResponse viewApiKeys(String appId) throws ApiException {
        ApiResponse<ApiKeyTokensListResponse> localVarResp = viewApiKeysWithHttpInfo(appId);
        return localVarResp.getData();
    }
     ...
     * View the details of all of your current app API keys (Rich Authentication Token) for a single OneSignal app.
     * @param appId  (required)
     * @return ApiResponse&lt;ApiKeyTokensListResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
    ...
    public ApiResponse<ApiKeyTokensListResponse> viewApiKeysWithHttpInfo(String appId) throws ApiException {
        okhttp3.Call localVarCall = viewApiKeysValidateBeforeCall(appId, null);
        Type localVarReturnType = new TypeToken<ApiKeyTokensListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * View API keys (asynchronously)
     * View the details of all of your current app API keys (Rich Authentication Token) for a single OneSignal app.
     * @param appId  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call viewApiKeysAsync(String appId, final ApiCallback<ApiKeyTokensListResponse> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = viewApiKeysValidateBeforeCall(appId, _callback);
        Type localVarReturnType = new TypeToken<ApiKeyTokensListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call viewTemplateValidateBeforeCall(String templateId, String appId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'templateId' is set
        if (templateId == null) {
            throw new ApiException("Missing the required parameter 'templateId' when calling viewTemplate(Async)");
        }
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling viewTemplate(Async)");
        }
        

        okhttp3.Call localVarCall = viewTemplateCall(templateId, appId, _callback);
        return localVarCall;
    ...
    public TemplateResource viewTemplate(String templateId, String appId) throws ApiException {
        ApiResponse<TemplateResource> localVarResp = viewTemplateWithHttpInfo(templateId, appId);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<TemplateResource> viewTemplateWithHttpInfo(String templateId, String appId) throws ApiException {
        okhttp3.Call localVarCall = viewTemplateValidateBeforeCall(templateId, appId, null);
        Type localVarReturnType = new TypeToken<TemplateResource>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call viewTemplateAsync(String templateId, String appId, final ApiCallback<TemplateResource> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = viewTemplateValidateBeforeCall(templateId, appId, _callback);
        Type localVarReturnType = new TypeToken<TemplateResource>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for viewTemplates
     * @param appId Your OneSignal App ID in UUID v4 format. (required)
     * @param limit Maximum number of templates. Default and max is 50. (optional, default to 50)
     * @param offset Pagination offset. (optional, default to 0)
     * @param channel Filter by delivery channel. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call viewTemplatesValidateBeforeCall(String appId, Integer limit, Integer offset, String channel, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling viewTemplates(Async)");
        }
        

        okhttp3.Call localVarCall = viewTemplatesCall(appId, limit, offset, channel, _callback);
        return localVarCall;
    ...
    public TemplatesListResponse viewTemplates(String appId, Integer limit, Integer offset, String channel) throws ApiException {
        ApiResponse<TemplatesListResponse> localVarResp = viewTemplatesWithHttpInfo(appId, limit, offset, channel);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<TemplatesListResponse> viewTemplatesWithHttpInfo(String appId, Integer limit, Integer offset, String channel) throws ApiException {
        okhttp3.Call localVarCall = viewTemplatesValidateBeforeCall(appId, limit, offset, channel, null);
        Type localVarReturnType = new TypeToken<TemplatesListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * View templates (asynchronously)
     * List templates for an app.
     * @param appId Your OneSignal App ID in UUID v4 format. (required)
     * @param limit Maximum number of templates. Default and max is 50. (optional, default to 50)
     * @param offset Pagination offset. (optional, default to 0)
    ...
    public okhttp3.Call viewTemplatesAsync(String appId, Integer limit, Integer offset, String channel, final ApiCallback<TemplatesListResponse> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = viewTemplatesValidateBeforeCall(appId, limit, offset, channel, _callback);
        Type localVarReturnType = new TypeToken<TemplatesListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    // OneSignal: surface the idempotent-retry helper as an instance method so
    // the call mirrors createNotification(). Delegates to NotificationHelpers
    // (single source of truth). Only meaningful on DefaultApi (the sole API).
    public com.onesignal.client.NotificationHelpers.CreateNotificationWithRetryResult createNotificationWithRetry(com.onesignal.client.model.Notification notification) throws ApiException {
        return com.onesignal.client.NotificationHelpers.createNotificationWithRetry(this, notification);
    }

    public com.onesignal.client.NotificationHelpers.CreateNotificationWithRetryResult createNotificationWithRetry(com.onesignal.client.model.Notification notification, int maxRetries, long baseDelayMillis) throws ApiException {
        return com.onesignal.client.NotificationHelpers.createNotificationWithRetry(this, notification, maxRetries, baseDelayMillis);
    }
}
